                ...
                @else
                    <a href="{{ route('login') }}"
                        class="px-4 py-2 text-sm font-medium
                            leading-5 text-white transition-colors duration-150 outline-1 outline-blue-600 border border-transparent
                            rounded-lg active:outline-blue-600 hover:outline-blue-600 focus:outline-none
                            focus:shadow-purple">Login</a>
                    <a href="{{ route('login') }}"
