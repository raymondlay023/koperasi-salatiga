<x-laporan-layout>
    ...
    <div class="mx-5">
        <div class="text-center mb-8 mt-6">
            <span class="text-3xl font-semibold ">Laporan Kedelai {{ $startDate }} hingga {{ $endDate }}</span>
        </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($result as $item)
                            <tr>
                                ...
                                @php
                                    $hppPembelian =
                                        $item['pembelian']['totalquantity'] > 0
                                            ? number_format(
                                                $item['pembelian']['totalprice'] / $item['pembelian']['totalquantity'],
                                                0,
                                                ',',
                                                '.',
                                            )
                                ...
                                <td>
                                    @if ($item['penjualan']['totalquantity'] > 0)
                                        @php
                                            $hpppenjualan =
                                                str_replace('.', '', $hppPembelian) *
                                                $item['penjualan']['totalquantity'];
                                ...
                                <td>
                                    Rp
                                    {{ number_format($item['penjualan']['totalprice'] - $hpppenjualan, 0, ',', '.') }}
                                </td>
                            </tr>
