<header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
    <div class="container flex items-center justify-between h-full px-6 mx-auto text-blue-600 dark:text-blue-300">
        ...
        <ul class="flex items-center flex-shrink-0 space-x-6">
            ...
            <!-- Notifications menu -->
            {{-- <li class="relative" x-data="{ open: isNotificationsMenuOpen }">
                <button class="relative align-middle rounded-md focus:outline-none focus:shadow-outline-blue"
                    @click="open = ! open" @keydown.escape="closeNotificationsMenu" aria-label="Notifications"
                    aria-haspopup="true">
                    <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                        <path
            ...
            <!-- Profile menu -->
            <li class="relative" x-data="{ open: isProfileMenuOpen }">
                <button class="align-middle rounded-full focus:shadow-outline-blue focus:outline-none flex items-center"
                    @click="open = ! open" @keydown.escape="closeProfileMenu" aria-label="Account" aria-haspopup="true">
